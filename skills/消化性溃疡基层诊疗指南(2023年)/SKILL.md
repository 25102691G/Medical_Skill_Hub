---
name: 消化性溃疡基层诊疗指南(2023年)
description: "主要疾病及适用范围：用于消化性溃疡（Peptic ulcer, PU）的诊断、鉴别诊断、治疗和随访管理，涵盖幽门螺杆菌（Hp）检测与根除、NSAIDs相关性溃疡的防治、基层转诊建议等。明确鉴别疾病：胃癌（Gastric cancer）、功能性消化不良（Functional dyspepsia）、慢性胆囊炎和胆石症（Chronic cholecystitis and cholelithiasis）、肝脏疾病（Liver diseases）、胰腺疾病（Pancreatic diseases）。"
---
...
使用本 skill 回答与《消化性溃疡基层诊疗指南(2023年)》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

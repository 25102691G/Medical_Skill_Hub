---
name: 中国药物性肝损伤诊治指南(2023年版)
description: "类别：肝脏疾病。用于药物性肝损伤（Drug-induced liver injury，DILI）的诊断、鉴别诊断、治疗和随访，仅在病例候选诊断包含药物性肝损伤时使用。"
---
...
使用本 skill 回答与《中国药物性肝损伤诊治指南（2023年版）》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

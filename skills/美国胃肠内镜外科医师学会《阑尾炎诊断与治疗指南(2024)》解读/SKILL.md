...
description: "类别：阑尾疾病。用于阑尾炎（Appendicitis）的诊断、鉴别诊断、治疗（手术与非手术）、手术时机、抗生素策略及随访，涵盖急性单纯性和复杂性阑尾炎，仅在病例候选诊断包含阑尾炎时使用。"
---
...
使用本 skill 回答与《阑尾炎诊断与治疗指南(2024)》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

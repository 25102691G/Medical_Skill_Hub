---
name: 肝硬化临床诊治管理指南(2025版)
description: "主要疾病及适用范围：用于肝硬化（Liver cirrhosis，LC）的诊断、分期（代偿期、失代偿期、再代偿期）、鉴别诊断、治疗、并发症防治及长期管理。明确鉴别疾病：假性肝硬化（Pseudocirrhosis）、非肝硬化性门静脉高压（Non-cirrhotic portal hypertension，NCPH）、肝性脊髓病（Hepatic myelopathy）、获得性肝脑变性（Acquired hepatocerebral degeneration）、肝肺综合征（Hepatopulmonary syndrome，HPS）、门静脉性肺动脉高压（Portopulmonary hypertension，POPH）。"
---
...
使用本 skill 回答与《肝硬化临床诊治管理指南(2025版)》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

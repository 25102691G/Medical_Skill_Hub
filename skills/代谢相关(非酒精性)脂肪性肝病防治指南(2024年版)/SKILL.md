...
description: "类别：肝脏疾病。用于代谢相关脂肪性肝病（metabolic dysfunction-associated fatty liver disease，MAFLD，亦称 MASLD）的筛查、监测、诊断、评估、治疗和随访，仅在病例候选诊断包含该疾病时使用。"
---

# 代谢相关(非酒精性)脂肪性肝病防治指南(2024 年版)

## 工作流程

使用本 skill 回答与《代谢相关(非酒精性)脂肪性肝病防治指南(2024 年版)》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。
...
- 明确说明回答依据《代谢相关(非酒精性)脂肪性肝病防治指南(2024 年版)》。
- 有推荐意见编号时，列出对应编号。

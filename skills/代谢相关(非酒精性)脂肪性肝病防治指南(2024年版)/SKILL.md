---
name: 代谢相关(非酒精性)脂肪性肝病防治指南(2024年版)
description: "主要疾病及适用范围：用于代谢相关脂肪性肝病（Metabolic dysfunction-associated fatty liver disease，MAFLD）的筛查、诊断、评估、治疗和随访。明确鉴别疾病：酒精性肝病（Alcohol-related liver disease，ALD）、继发性脂肪性肝病（Secondary fatty liver disease）、隐源性脂肪性肝病（Cryptogenic fatty liver disease）、慢性乙型肝炎（Chronic hepatitis B，CHB）、慢性丙型肝炎（Chronic hepatitis C，CHC）。"
---
...
使用本 skill 回答与《代谢相关(非酒精性)脂肪性肝病防治指南(2024年版)》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。
...
- 明确说明回答依据《代谢相关(非酒精性)脂肪性肝病防治指南(2024年版)》。
- 有推荐意见编号时，列出对应编号。

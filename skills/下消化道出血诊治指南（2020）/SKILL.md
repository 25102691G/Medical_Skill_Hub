---
name: 下消化道出血诊治指南（2020）
description: "主要疾病及适用范围：用于下消化道出血（lower gastrointestinal bleeding，LGIB）的诊断、鉴别诊断、治疗和随访，涵盖小肠出血和结直肠出血。明确鉴别疾病：上消化道出血（upper gastrointestinal bleeding）、痔疮（hemorrhoids）、肛裂（anal fissure）。"
---
...
使用本 skill 回答与《下消化道出血诊治指南（2020）》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

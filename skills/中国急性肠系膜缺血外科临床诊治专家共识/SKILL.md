---
name: 中国急性肠系膜缺血外科临床诊治专家共识
description: "主要疾病及适用范围：用于急性肠系膜缺血（acute mesenteric ischemia，AMI）的早期识别、病因分析、影像学诊断、外科干预决策（包括血运重建、腹腔镜探查、损伤控制手术）、药物治疗及长期随访管理，涵盖急性闭塞性肠系膜缺血（AOMI）和非闭塞性肠系膜缺血（NOMI）各亚型。明确鉴别疾病：机械性肠梗阻（Mechanical intestinal obstruction）、绞窄性肠梗阻（Strangulated intestinal obstruction）、结节性多动脉炎（Polyarteritis nodosa）。"
---
...
使用本 skill 回答与《中国急性肠系膜缺血外科临床诊治专家共识（2025 版）》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。
...
- 明确说明回答依据《中国急性肠系膜缺血外科临床诊治专家共识（2025 版）》。
- 有推荐意见编号时，列出对应编号。
...
- AOMI：acute occlusive mesenteric ischemia
- NOMI：non-occlusive mesenteric ischemia
- AMAE：acute mesenteric artery embolism
- AMAT：acute mesenteric arterial thrombosis
- AMVT：acute mesenteric venous thrombosis
- SMAD：superior mesenteric artery dissection
- SMA：superior mesenteric artery
- SMV：superior mesenteric vein
- CTA：CT angiography
- DCS：damage control surgery
- ISC：intestinal stroke center

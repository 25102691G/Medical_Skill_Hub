---
name: 慢加急性肝衰竭诊治指南(2025年版)
description: "类别：肝脏疾病。用于慢加急性肝衰竭（Acute-on-chronic liver failure，ACLF）的诊断、分型、预后评估、内科综合治疗、非生物型人工肝支持治疗、肝移植、营养支持及并发症防治，仅在病例候选诊断包含该疾病时使用。"
---
...
使用本 skill 回答与《慢加急性肝衰竭诊治指南(2025年版)》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

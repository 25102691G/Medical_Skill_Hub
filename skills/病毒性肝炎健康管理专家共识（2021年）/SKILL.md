---
name: 病毒性肝炎健康管理专家共识（2021年）
description: "主要疾病及适用范围：用于病毒性肝炎（Viral hepatitis，包括乙型肝炎病毒HBV和丙型肝炎病毒HCV感染）的筛查、诊断、健康管理、治疗转诊和随访。明确鉴别疾病：无。"
---
...
使用本 skill 回答与《病毒性肝炎健康管理专家共识（2021年）》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

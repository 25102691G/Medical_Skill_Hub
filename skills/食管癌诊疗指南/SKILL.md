---
name: 食管癌诊疗指南
description: "主要疾病及适用范围：用于食管癌（Esophageal Cancer，EC）的诊断、分期、筛查、治疗（外科、放疗、系统性药物、内镜）、营养支持及随访。明确鉴别疾病：胃癌（Gastric cancer）、淋巴瘤（Lymphoma）、肉瘤（Sarcoma）、胃肠道间质瘤（Gastrointestinal stromal tumor）、黑色素瘤（Melanoma）、神经内分泌瘤（Neuroendocrine tumor）。"
---
...
使用本 skill 回答与《食管癌诊疗指南（2022年版）》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

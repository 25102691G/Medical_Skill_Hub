---
name: 弥漫性恶性腹膜间皮瘤诊治中国专家共识
description: "类别：腹膜和腹膜后疾病。用于弥漫性恶性腹膜间皮瘤（Diffuse malignant peritoneal mesothelioma，DMPM）的诊断、鉴别诊断、治疗和随访，仅在病例候选诊断包含该疾病时使用。"
---
...
使用本 skill 回答与《弥漫性恶性腹膜间皮瘤诊治中国专家共识》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

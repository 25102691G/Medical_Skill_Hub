---
name: 肠型贝赫切特综合征(肠白塞病)诊断和治疗共识意见
description: "类别：肠的其他疾病。用于肠型贝赫切特综合征（肠白塞病，Intestinal Behçet's disease，Intestinal BD）的诊断、鉴别诊断、疾病活动度评价和治疗，仅在病例候选诊断包含肠白塞病时使用。"
---
...
使用本 skill 回答与《肠型贝赫切特综合征（肠白塞病）诊断和治疗共识意见》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。
...
- 明确说明回答依据《肠型贝赫切特综合征（肠白塞病）诊断和治疗共识意见》。
- 有推荐意见编号时，列出对应编号。

---
name: 慢性胰腺炎诊治指南（2018，广州）
description: "主要疾病及适用范围：用于慢性胰腺炎（Chronic pancreatitis，CP）的诊断、鉴别诊断、治疗和随访。明确鉴别疾病：胰腺癌（pancreatic cancer）。"
---
...
使用本 skill 回答与《慢性胰腺炎诊治指南(2018,广州)》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

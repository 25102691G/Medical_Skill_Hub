---
name: 胃食管反流病中西医结合诊疗专家共识（2025年）
description: "主要疾病及适用范围：用于胃食管反流病（Gastroesophageal reflux disease，GERD）的诊断、鉴别诊断、中西医结合治疗和随访管理。明确鉴别疾病：功能性烧心（Functional heartburn）、贲门失弛缓症（Achalasia）、弥漫性食管痉挛（Diffuse esophageal spasm）、胡桃夹食管（Nutcracker esophagus）、硬皮病（Scleroderma）。"
---
...
使用本 skill 回答与《胃食管反流病中西医结合诊疗专家共识(2025年)》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。
...
- 明确说明回答依据《胃食管反流病中西医结合诊疗专家共识(2025年)》。
- 有推荐意见编号时，列出对应编号。

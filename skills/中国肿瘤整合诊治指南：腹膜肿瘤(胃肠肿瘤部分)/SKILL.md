---
name: 中国肿瘤整合诊治指南：腹膜肿瘤(胃肠肿瘤部分)
description: "类别：腹膜和腹膜后疾病。用于胃肠来源的腹膜肿瘤（Peritoneal tumours from gastrointestinal tract，主要包括胃癌、结直肠癌、阑尾黏液瘤等继发性腹膜转移及腹膜假黏液瘤[PMP]）的预防、筛查、诊断、以细胞减灭术（CRS）联合腹腔热灌注化疗（HIPEC）为主的整合治疗、中医与营养支持治疗及随访，仅在病例候选诊断涉及上述疾病时使用。"
---
...
使用本 skill 回答与《中国肿瘤整合诊治指南：腹膜肿瘤(胃肠肿瘤部分)》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。
...
- 明确说明回答依据《中国肿瘤整合诊治指南：腹膜肿瘤(胃肠肿瘤部分)》。
- 有推荐意见编号时，列出对应编号。

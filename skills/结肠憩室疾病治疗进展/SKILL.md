---
name: 结肠憩室疾病治疗进展
description: "类别：肠的其他疾病。用于结肠憩室疾病（colonic diverticular disease）的诊断分型、药物治疗、外科治疗和随访，涵盖急性单纯性憩室炎（AUD）、急性复杂性憩室炎（ACD）和症状性无并发症憩室病（SUDD），仅在病例候选诊断包含结肠憩室疾病或憩室炎时使用。"
---
...
使用本 skill 回答与《结肠憩室疾病治疗进展》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

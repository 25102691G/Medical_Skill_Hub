---
name: 胰腺癌诊疗指南(2022年版)
description: "主要疾病及适用范围：用于胰腺癌（Pancreatic cancer，PC）的诊断、鉴别诊断、分期、治疗和随访。明确鉴别疾病：慢性胰腺炎（Chronic pancreatitis）、壶腹癌（Ampullary carcinoma）、胰腺囊腺瘤与囊腺癌（Pancreatic cystadenoma and cystadenocarcinoma）、胆总管结石（Choledocholithiasis）、胰腺假性囊肿（Pancreatic pseudocyst）、胰岛素瘤（Insulinoma）、实性假乳头状瘤（Solid pseudopapillary neoplasm）。"
---

---
name: 胰腺癌诊疗指南(2022年版)
description: "类别：胆囊、胆道和胰腺疾病。用于胰腺导管腺癌（Pancreatic ductal adenocarcinoma，PDAC）的诊断、鉴别诊断、治疗和随访，仅在病例候选诊断包含该疾病时使用。"
---
...
使用本 skill 回答与《胰腺癌诊疗指南（2022 年版）》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

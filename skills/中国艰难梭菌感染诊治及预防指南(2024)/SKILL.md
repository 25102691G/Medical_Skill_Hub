---
name: 中国艰难梭菌感染诊治及预防指南(2024)
description: "主要疾病及适用范围：用于艰难梭菌感染（Clostridioides difficile infection，CDI）的诊断、治疗和预防。明确鉴别疾病：无。"
---
...
使用本 skill 回答与《中国艰难梭菌感染诊治及预防指南(2024)》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

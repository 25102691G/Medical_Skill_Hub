---
name: 妊娠合并急性阑尾炎诊治专家共识(2026)
description: "类别：阑尾疾病。用于妊娠合并急性阑尾炎（Acute appendicitis during pregnancy）的诊断、鉴别诊断、治疗和随访，仅在病例候选诊断包含该疾病时使用。"
---

# 妊娠合并急性阑尾炎诊治专家共识(2026)

## 工作流程

使用本 skill 回答与《妊娠合并急性阑尾炎诊治专家共识(2026)》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

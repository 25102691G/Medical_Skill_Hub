---
name: 放射性肠炎发病机制及综合防治策略的研究进展
description: "类别：非感染性小肠炎结肠炎。用于放射性肠炎（Radiation enteritis，RE）的发病机制、预防与治疗策略查询，仅在涉及盆腹腔放疗后肠道损伤相关问题时使用。"
---

# 放射性肠炎发病机制及综合防治策略的研究进展

## 工作流程

使用本 skill 回答与《放射性肠炎发病机制及综合防治策略的研究进展》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。
...
- 明确说明回答依据《放射性肠炎发病机制及综合防治策略的研究进展》。
- 有推荐意见编号时，列出对应编号。

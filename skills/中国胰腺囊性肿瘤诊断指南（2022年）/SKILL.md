---
name: 中国胰腺囊性肿瘤诊断指南（2022年）
description: "主要疾病及适用范围：用于胰腺囊性肿瘤（pancreatic cystic neoplasm，PCN）的诊断、鉴别诊断、治疗和随访。涵盖影像学检查、超声内镜（EUS）评估、超声内镜引导下细针穿刺抽吸/活检（EUS-FNA/FNB）、囊液分析及随访监测策略等临床问题。明确鉴别疾病：胰腺假性囊肿（pancreatic pseudocyst）、黏液性囊性肿瘤（mucinous cystic neoplasm，MCN）、导管内乳头状黏液性肿瘤（intraductal papillary mucinous neoplasm，IPMN）、浆液性囊腺瘤（serous cystic neoplasm，SCN）、实性假乳头状肿瘤（solid pseudopapillary neoplasm，SPN）、囊性神经内分泌肿瘤（cystic neuroendocrine tumour，cNET）。"
---
...
使用本 skill 回答与《中国胰腺囊性肿瘤诊断指南（2022年）》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。
...
- PCN：pancreatic cystic neoplasm（胰腺囊性肿瘤）
- MCN：mucinous cystic neoplasm（黏液性囊性肿瘤）
- IPMN：intraductal papillary mucinous neoplasm（导管内乳头状黏液性肿瘤）
- SCN：serous cystic neoplasm（浆液性囊腺瘤）
- SPN：solid pseudopapillary neoplasm（实性假乳头状肿瘤）
- cNET：cystic neuroendocrine tumour（囊性神经内分泌肿瘤）
- EUS：endoscopic ultrasound（超声内镜检查术）
- EUS-FNA/FNB：EUS-guided fine needle aspiration/biopsy（超声内镜引导下细针穿刺抽吸/活检）

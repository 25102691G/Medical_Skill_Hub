---
name: 中国恶性肿瘤整合诊治指南-结肠癌_2024版_
description: "主要疾病及适用范围：用于结肠癌（Colon cancer）的预防筛查、诊断（包括MSI/dMMR检测）、外科治疗（CME手术）、内科治疗（化疗、靶向、免疫）、中医药治疗及全程康复管理，涵盖ctDNA、免疫治疗、肝转移综合诊治等关键内容。明确鉴别疾病：无。"
---
...
使用本 skill 回答与《中国恶性肿瘤整合诊治指南-结肠癌（2024版）》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。
...
- 明确说明回答依据《中国恶性肿瘤整合诊治指南-结肠癌（2024版）》。
- 有推荐意见编号时，列出对应编号。

---
name: 缺血性结肠炎
description: "主要疾病及适用范围：用于缺血性结肠炎（ischemic colitis，IC）的诊断、鉴别诊断、辅助检查选择及治疗，涵盖其危险因素、临床表现、内镜和影像学特征，以及内科保守治疗和外科手术指征。明确鉴别疾病：炎症性肠病（inflammatory bowel disease）、结肠癌（colon cancer）。"
---
...
使用本 skill 回答与《缺血性结肠炎》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。
...
- IC：缺血性结肠炎（ischemic colitis）
- IRCI：孤立性右半结肠缺血（isolated right colon ischemia）

---
name: 中国急性胰腺炎诊治指南(2021)
description: "类别：胆囊、胆道和胰腺疾病。用于急性胰腺炎（acute pancreatitis，AP）的诊断、治疗、随访及复发预防，仅在病例候选诊断包含该疾病时使用。"
---
...
使用本 skill 回答与《中国急性胰腺炎诊治指南(2021)》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

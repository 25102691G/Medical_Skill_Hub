---
name: 肠结核的诊断与治疗
description: "主要疾病及适用范围：用于肠结核（Intestinal tuberculosis，ITB）的诊断、鉴别诊断、治疗和随访。明确鉴别疾病：克罗恩病（Crohn disease）。"
---
...
使用本 skill 回答与《肠结核的诊断与治疗》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

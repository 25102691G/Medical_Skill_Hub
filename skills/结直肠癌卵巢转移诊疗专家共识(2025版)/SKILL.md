---
name: 结直肠癌卵巢转移诊疗专家共识(2025版)
description: "类别：肠的其他疾病。用于结直肠癌卵巢转移（Colorectal cancer with ovarian metastasis）的诊断、鉴别诊断、治疗和随访，仅在病例候选诊断包含该疾病时使用。"
---
...
使用本 skill 回答与《结直肠癌卵巢转移诊疗专家共识（2025版）》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

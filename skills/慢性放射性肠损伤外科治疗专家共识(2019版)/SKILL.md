---
name: 慢性放射性肠损伤外科治疗专家共识(2019版)
description: "类别：非感染性小肠炎结肠炎。用于慢性放射性肠损伤（Chronic radiation intestinal injury，又称放射性肠病、放射性肠炎，常涉及短肠综合征等相关并发症）的外科治疗、营养治疗及并发症处理，适用场景为盆腔放疗后出现慢性消化道症状（如肠梗阻、肠瘘、出血等）需要外科干预的临床决策，仅在病例候选诊断包含放射性肠损伤时使用。"
---
...
使用本 skill 回答与《慢性放射性肠损伤外科治疗专家共识（2019版）》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。
...
- 明确说明回答依据《慢性放射性肠损伤外科治疗专家共识（2019版）》。
- 有推荐意见编号时，列出对应编号。

---
name: 肝纤维化诊断与治疗共识（2019年）
description: "主要疾病及适用范围：用于肝纤维化（Hepatic fibrosis，HF）的诊断、评估、治疗和随访。明确鉴别疾病：无。"
---
...
使用本 skill 回答与《肝纤维化诊断及治疗共识（2019年）》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

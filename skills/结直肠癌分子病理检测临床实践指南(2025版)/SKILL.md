---
name: 结直肠癌分子病理检测临床实践指南(2025版)
description: "类别：肠的其他疾病。用于结直肠癌（Colorectal cancer，CRC）的分子病理检测、诊断、治疗决策和遗传性综合征筛查，涵盖检测原则、标志物选择及质量控制，仅在临床病例涉及结直肠癌的精准诊疗时使用。"
---
...
使用本 skill 回答与《结直肠癌分子病理检测临床实践指南(2025版)》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。
...
- 明确说明回答依据《结直肠癌分子病理检测临床实践指南(2025版)》。
- 有推荐意见编号时，列出对应编号。

---
name: 便秘型肠易激综合征的治疗进展
description: "主要疾病及适用范围：用于便秘型肠易激综合征（Irritable bowel syndrome with constipation，IBS-C）的治疗（包括非药物和药物治疗）及临床管理。明确鉴别疾病：无。"
---
...
使用本 skill 回答与《便秘型肠易激综合征的治疗进展》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

1. 完整读取 `references/recommendations-index.md`，根据问题或病例阳性特征语义匹配相关治疗建议、诊断标准、鉴别诊断、检查、治疗、监测、随访等重要信息。
...
- IBS-C：便秘型肠易激综合征 (Irritable bowel syndrome with constipation)
- IBS：肠易激综合征 (Irritable bowel syndrome)

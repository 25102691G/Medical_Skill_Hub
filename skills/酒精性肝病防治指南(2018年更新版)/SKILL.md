...
description: "类别：肝脏疾病。用于酒精性肝病（Alcoholic liver disease，ALD）的诊断、鉴别诊断、治疗和随访，仅在病例候选诊断包含该疾病时使用。"
---
...
使用本 skill 回答与《酒精性肝病防治指南（2018年更新）》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

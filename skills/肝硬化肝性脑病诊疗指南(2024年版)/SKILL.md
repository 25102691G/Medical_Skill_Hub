---
name: 肝硬化肝性脑病诊疗指南(2024年版)
description: "主要疾病及适用范围：用于肝硬化肝性脑病（Hepatic encephalopathy in cirrhosis，HE）的诊断、鉴别诊断、治疗、一级和二级预防及全程管理。明确鉴别疾病：精神障碍、颅内病变、其他代谢性脑病、韦尼克脑病、中毒性脑病、肝硬化相关帕金森病、肝性脊髓病、获得性肝脑变性、急性脑病、认知障碍。"
---
...
使用本 skill 回答与《肝硬化肝性脑病诊疗指南(2024年版)》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

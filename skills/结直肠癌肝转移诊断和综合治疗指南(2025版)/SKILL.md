---
name: 结直肠癌肝转移诊断和综合治疗指南(2025版)
description: "主要疾病及适用范围：用于结直肠癌肝转移（colorectal cancer liver metastases，CRLM）的诊断、鉴别诊断、预防、手术及局部毁损治疗、新辅助及辅助治疗、综合治疗和随访。明确鉴别疾病：无。"
---
...
使用本 skill 回答与《结直肠癌肝转移诊断和综合治疗指南（2025版）》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。
...
- 明确说明回答依据《结直肠癌肝转移诊断和综合治疗指南（2025版）》。
- 有推荐意见编号时，列出对应编号。
...
- RASPE：radiological simultaneous portohepatic vein embolization

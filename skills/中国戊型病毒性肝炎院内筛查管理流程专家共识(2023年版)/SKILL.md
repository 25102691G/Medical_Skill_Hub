---
name: 中国戊型病毒性肝炎院内筛查管理流程专家共识(2023年版)
description: "主要疾病及适用范围：用于戊型病毒性肝炎（Hepatitis E，HEV）的院内筛查、诊断、鉴别诊断、治疗、会诊转诊及随访管理。明确鉴别疾病：甲型肝炎、药物性肝损伤、自身免疫性肝病。"
---

# 中国戊型病毒性肝炎院内筛查管理流程专家共识（2023 年版）

## 工作流程

使用本 skill 回答与《中国戊型病毒性肝炎院内筛查管理流程专家共识（2023 年版）》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。
...
- 明确说明回答依据《中国戊型病毒性肝炎院内筛查管理流程专家共识（2023 年版）》。
- 有推荐意见编号时，列出对应编号。

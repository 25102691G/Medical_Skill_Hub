---
name: 肛瘘的诊治专家共识(2020版)
description: "主要疾病及适用范围：用于肛瘘（Anal fistula，AF）的病因评估、分类、辅助检查选择、治疗原则与手术方式（挂线、肛瘘切开、LIFT、瘘管填塞、VAAFT等）、术后肛门功能评估和随访。明确鉴别疾病：肛周脓肿（Perianal abscess）、溃疡性结肠炎（Ulcerative colitis）、肠结核（Intestinal tuberculosis）。"
---
...
使用本 skill 回答与《肛瘘的诊治专家共识（2020版）》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。
...
- VAAFT：Video-assisted anal fistula resection

---
name: 阑尾上皮肿瘤腹膜转移综合诊治专家共识(2025版)
description: "类别：腹膜和腹膜后疾病。用于阑尾上皮肿瘤腹膜转移（Appendiceal epithelial neoplasms with peritoneal metastasis），包括腹膜假黏液瘤（pseudomyxoma peritonei，PMP），的诊断、治疗和随访，仅在病例涉及阑尾上皮肿瘤及其腹膜转移时使用。"
---
...
使用本 skill 回答与《阑尾上皮肿瘤腹膜转移综合诊治专家共识(2025版)》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。
...
- 明确说明回答依据《阑尾上皮肿瘤腹膜转移综合诊治专家共识(2025版)》。
- 有推荐意见编号时，列出对应编号。

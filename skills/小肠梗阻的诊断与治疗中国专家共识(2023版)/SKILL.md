---
name: 小肠梗阻的诊断与治疗中国专家共识(2023版)
description: "主要疾病及适用范围：用于小肠梗阻（Small bowel obstruction，SBO）的诊断、鉴别诊断和内外科治疗，涵盖影像学检查、非手术治疗及手术策略。明确鉴别疾病：结肠梗阻（Colonic obstruction）、慢性假性肠梗阻（Chronic intestinal pseudo-obstruction，CIPO）。"
---
...
使用本 skill 回答与《小肠梗阻的诊断与治疗中国专家共识(2023版)》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。
...
- 明确说明回答依据《小肠梗阻的诊断与治疗中国专家共识(2023版)》。
- 有推荐意见编号时，列出对应编号。
...
- EPII：early postoperative inflammatory ileus

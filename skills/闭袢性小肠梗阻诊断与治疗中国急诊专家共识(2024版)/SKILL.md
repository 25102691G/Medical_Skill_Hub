---
name: 闭袢性小肠梗阻诊断与治疗中国急诊专家共识(2024版)
description: "主要疾病及适用范围：用于闭袢性小肠梗阻（Closed-loop small bowel obstruction，CL-SBO）的诊断、鉴别诊断、治疗和随访。明确鉴别疾病：非闭袢性小肠梗阻（Non-closed-loop small bowel obstruction）。"
---
...
使用本 skill 回答与《闭袢性小肠梗阻诊断与治疗中国急诊专家共识(2024版)》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。
...
- 明确说明回答依据《闭袢性小肠梗阻诊断与治疗中国急诊专家共识(2024版)》。
- 有推荐意见编号时，列出对应编号。
...
- CL-SBO：Closed-loop small bowel obstruction
- WBC：白细胞计数
- PCT：降钙素原
- CRP：C反应蛋白
- NLR：中性粒细胞-淋巴细胞比率

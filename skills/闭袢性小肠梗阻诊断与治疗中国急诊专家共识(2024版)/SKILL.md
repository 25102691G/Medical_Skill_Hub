...
description: "类别：肠的其他疾病。用于闭袢性小肠梗阻（Closed-loop small bowel obstruction，CL-SBO）的诊断、治疗和随访，仅在病例候选诊断包含该疾病时使用。"
---

# 闭袢性小肠梗阻诊断与治疗中国急诊专家共识(2024 版)

## 工作流程

使用本 skill 回答与《闭袢性小肠梗阻诊断与治疗中国急诊专家共识(2024 版)》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。
...
- 明确说明回答依据《闭袢性小肠梗阻诊断与治疗中国急诊专家共识(2024 版)》。
- 有推荐意见编号时，列出对应编号。

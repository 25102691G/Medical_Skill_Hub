---
name: 缺血性肠病的危险因素及其诊治研究进展
description: "主要疾病及适用范围：用于缺血性肠病（Ischemic bowel disease，IBD）的诊断、鉴别诊断、治疗和随访。明确鉴别疾病：溃疡性结肠炎（Ulcerative colitis）。"
---
...
使用本 skill 回答与《缺血性肠病的危险因素及其诊治研究进展》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。
...
- IBD：缺血性肠病（Ischemic bowel disease）

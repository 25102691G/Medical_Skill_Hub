---
name: 淋巴瘤诊疗指南
description: "类别：肠的其他疾病。用于淋巴瘤（Lymphoma，包括霍奇金淋巴瘤Hodgkin lymphoma，HL 和非霍奇金淋巴瘤non-Hodgkin lymphoma，NHL）的诊断、鉴别诊断、治疗和随访，仅在病例候选诊断包含该疾病时使用。"
---
...
使用本 skill 回答与《淋巴瘤诊疗指南》相关的问题时，以 `references/guideline-full-text.md` 为原文依据。

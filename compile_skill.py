...
GUIDELINE_SEARCH_SCRIPT = (
    ROOT_DIR / "diagnosis" / "agents" / "guideline_skill_search.py"
)
...
def _write_skill_directory(
    ...
    _write_text(
        skill_dir / "scripts" / "search_guideline.py",
        GUIDELINE_SEARCH_SCRIPT.read_text(encoding="utf-8"),
    )
